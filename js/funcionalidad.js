...
modo.addEventListener ("click", function(){
    if (modo.className.includes("fa-sun")){
        ...
        document.documentElement.style.setProperty('--color-1', '#000f08');
        document.documentElement.style.setProperty('--color-2', '#000f08');
        document.documentElement.style.setProperty('--color-3', '#cd9fcc');
        document.documentElement.style.setProperty('--color-pagina', '#000f08');
        document.documentElement.style.setProperty('--color-texto', '#fafafa');
        ...
        document.documentElement.style.setProperty('--color-1', '#edb');
        document.documentElement.style.setProperty('--color-2', '#6bada9');
        document.documentElement.style.setProperty('--color-3', '#edbf85');
